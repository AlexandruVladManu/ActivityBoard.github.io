...
function getSavedColumns() {
	if (localStorage.getItem('backlogItems')) {
		...
		backlogListArray = ['Finish Node.js Course', 'Sit back and relax'];
		progressListArray = ['Work on projects', 'Learn React'];
		completeListArray = ['Being cool', 'Upload Portfolio'];
		onHoldListArray = ['Change the car'];
	}
}
